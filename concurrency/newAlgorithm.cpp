...
int main() {
  ...
  std::inclusive_scan(
      std::execution::par, resVec2.begin(), resVec2.end(), resVec2.begin(),
  ...
  std::transform_exclusive_scan(
      std::execution::par, resVec3.begin(), resVec3.end(), resVec4.begin(), 0,
      [](auto fir, int sec) { return fir + sec; },
  ...
  std::transform_inclusive_scan(
      std::execution::par, strVec.begin(), strVec.end(), resVec5.begin(),
      [](auto fir, auto sec) { return fir + sec; },
      [](auto s) { return s.length(); }, static_cast<std::size_t>(0));
  ...
  std::string res = std::reduce(
      std::execution::par, strVec2.begin() + 1, strVec2.end(), strVec2[0],
      [](auto fir, auto sec) { return fir + ":" + sec; });

  std::cout << "reduce: " << res << '\n';

  auto res7 = std::transform_reduce(
      std::execution::par, strVec2.begin(), strVec2.end(),
      static_cast<std::size_t>(0), [](auto a, auto b) { return a + b; },
